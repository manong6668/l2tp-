...
preinstall_l2tp(){
    ...
    echo "请输入预共享密钥:"
    read -p "(默认预共享密钥: manong166):" mypsk
    [ -z ${mypsk} ] && mypsk="manong166"

    echo "请输入用户名:"
    read -p "(默认用户名: manong166):" username
    [ -z ${username} ] && username="manong166"
